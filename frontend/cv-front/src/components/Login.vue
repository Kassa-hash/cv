<template>
  <div class="rounded-lg py-12 dark:bg-slate-900">
    ...
    <div
      class="m-6 mt-10 flex flex-col justify-center rounded-lg bg-white px-6 py-12 sm:mx-auto sm:w-full sm:max-w-md lg:px-8 dark:bg-slate-950"
    >
    ...
    <p class="mt-10 text-center text-sm dark:text-white">
      ...
      <a
        href="#"
        class="inline-flex font-semibold leading-6 text-orange-500 hover:text-orange-600"
      >
        Register Today!
      </a>
    </p>
